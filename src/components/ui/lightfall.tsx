...
const Lightfall = React.forwardRef<HTMLDivElement, LightfallProps>(
  (
    {
      className,
      dpr,
    ...
    useEffect(() => {
      ...
      const uniforms = {
        ...
        iTime: { value: 0 },
        uColor0: { value: arr[0] as [number, number, number] },
        uColor1: { value: arr[1] as [number, number, number] },
        uColor2: { value: arr[2] as [number, number, number] },
        uColor3: { value: arr[3] as [number, number, number] },
        uColor4: { value: arr[4] as [number, number, number] },
        uColor5: { value: arr[5] as [number, number, number] },
        uColor6: { value: arr[6] as [number, number, number] },
        uColor7: { value: arr[7] as [number, number, number] },
        uColorCount: { value: count },
        uBgColor: { value: hexToRGB(backgroundColor) as [number, number, number] },
        uMouseColor: { value: avg as [number, number, number] },
        uSpeed: { value: speed },
      ...
      const resize = () => {
        ...
        uniforms.iResolution.value = [gl.drawingBufferWidth, gl.drawingBufferHeight, 1] as [number, number, number];
      };
